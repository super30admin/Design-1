...
But then I had to increase size of primary array.
Now it runs successful but my space complexity has increased.


// Your code here along with comments explaining your approach
Create a primary array. Each element of this array will be having list lists.
Basically we are using linear-chaining. Data Structure used for chaining is linked
list.
Value of hash value (key % sizeof(primary_array)) is index of primary array.
We add key value pair at that location. If that location is occupied, then linear
chaining is used.
