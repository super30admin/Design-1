 ...
 */
 ...
 where N is the number of all possible keys and K is the number of predefined buckets in the hashmap. 

 Space Complexity: O(K+M) where 
 K is the number of predefined buckets in the hashmap and M is the number of unique keys that have been inserted into the hashmap. 
 */