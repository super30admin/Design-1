...
Approach here is to store min_value of stack while doing push operation.
By this we can get current minimun and also keep track of 2nd minimum (helpful when we pop current minimum)
